...
class othRequestForm extends StatefulWidget {
  @override
  _othRequestFormState createState() => _othRequestFormState();
}

class _othRequestFormState extends State<othRequestForm> {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    fireStore.collection("othertrack").doc("$userEmail").set({
                      "Advisor":"False",
                      "HOD":"False"
                    });
