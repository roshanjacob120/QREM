...
class dutyRequestForm extends StatefulWidget {
  @override
  _dutyRequestFormState createState() => _dutyRequestFormState();
}

class _dutyRequestFormState extends State<dutyRequestForm> {
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text("Your duty leave request has been sent."),
            actions: [
              TextButton(
                  onPressed: () {
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    fireStore
                      ...
                      "Time out":  _selectedTime!.format(context),
                      "Date": _selectedDate.toString(),
                      "Status": "false"
                    }).then((value) {
                      _showSuccessPopup();
                    });
                    fireStore.collection("dutytrack").doc("$userEmail").set({
                      "Advisor":"False",
                      "HOD":"False"
                    });
