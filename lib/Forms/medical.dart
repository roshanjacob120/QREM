...
class medRequestForm extends StatefulWidget {
  @override
  _medRequestFormState createState() => _medRequestFormState();
}

class _medRequestFormState extends State<medRequestForm> {
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text("Your Medical leave request has been sent."),
            actions: [
              TextButton(
                  onPressed: () {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    fireStore.collection("medleavetrack").doc("$userEmail").set({
                      "Advisor":"False",
                      "HOD":"False"
                    });
