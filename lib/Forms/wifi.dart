...
class wifiRequestForm extends StatefulWidget {
  @override
  _wifiRequestFormState createState() => _wifiRequestFormState();
}

class _wifiRequestFormState extends State<wifiRequestForm> {
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text("Your Wi-fi request has been sent."),
            actions: [
              TextButton(
                  onPressed: () {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    fireStore.collection("wifitrack").doc("$userEmail").set({
                      "Advisor":"False",
                      "HOD":"False"
                    });
