...
class latentrystatusPage extends StatefulWidget {
  @override
  _latentrystatusPageState createState() => _latentrystatusPageState();
}

class _latentrystatusPageState extends State<latentrystatusPage> {
  int _currentStep = 0;
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Container(
            ...
            child: Center(
              child: QrImage(
                data: 'Accepted By HOD:Dr.Jisha John\n Accepted by advisor:Asha S \nReason:Sick \nAttached People:None\nTimeout:5:50 PM\nDate:2023-05-19',
              ...
              builder: (context, snapshot) {
                ...
                List<Step> _steps = [
                  Step(
                    ...
                    content: Text(
                      'Your late entry request has been sent.',
                  ...
                  Step(
                    ...
                    content: Text(
                      'Your late entry request has been approved and QR code has been generated.',
                      style: GoogleFonts.sulphurPoint(fontSize: 18),
                    ),
